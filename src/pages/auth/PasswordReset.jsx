...
const SetNewPassword = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (password !== confirmPassword) {
			setError(t('password_reset_page.passwords_do_not_match'))
			return
		}
		...
		try {
			...
			setError(t('password_reset_page.password_reset_failed'))
		}
	}
					...
					<div className='max-w-md w-full space-y-8'>
						<div>
							<h1 className='mt-6 text-center text-3xl font-extrabold text-secondary-text'>
								{t('password_reset_page.set_new_password')}
							</h1>
						</div>
						...
						>
							<div className='flex flex-col gap-4 rounded-md -space-y-px text-left'>
								<div>
									...
									>
										{t('password_reset_page.new_password')}
									</label>
									<div className='relative'>
										<input
											...
											placeholder={t(
												'password_reset_page.enter_new_password'
											)}
											value={password}
								...
								<div>
									...
									>
										{t(
											'password_reset_page.confirm_new_password'
										)}
									</label>
									<div className='relative'>
										<input
											...
											placeholder={t(
												'password_reset_page.confirm_new_password_placeholder'
											)}
								...
								<div className='p-2'>
									...
									{success && (
										<p className='text-sm text-green-600'>
											{t(
												'password_reset_page.password_reset_success'
											)}
										</p>
									)}
								</div>
							...
							<div>
								...
								>
									{t(
										'password_reset_page.set_new_password_button'
									)}
								</button>
							</div>
						</form>
